...
st.markdown("这个是Steam官网的链接[点击一下](https://store.steampowered.com/?l=schinese)")
st.markdown("这个是育碧官网的链接[点击一下](https://zh-cn.ubisoft.com)")
st.markdown("这个是Epic官网的链接[点击一下](https://store.epicgames.com/en-US/)")
